            ...
            <div class="wrap clearfix">
                ...
                <div class="col-4">
                    <div class="item">
                        ...
                        <p class="text">К нам приходят с разными <br> проблемами — лишний вес, <br> плоская попа, изъяны фигуры или плохое самочувствие. Все, кто остается с нами, решают эти <br> проблемы очень быстро. Команда HiitWorks знает, как сделать девочек <br> красивыми! </p>
                    </div>
                </div>
